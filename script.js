...
const StackedCards = {
    ...
    updateCards: function(oldIndex, newIndex) {
        ...
        cards.forEach((card, index) => {
            ...
            const zIndex = this.data.length - Math.abs(cardIndex - newIndex);
            const offset = Math.abs(cardIndex - newIndex) * 20;
            const scale = 1 - (Math.abs(cardIndex - newIndex) * 0.05);
            const blur = Math.abs(cardIndex - newIndex) * 2;
            const opacity = 1 - (Math.abs(cardIndex - newIndex) * 0.2);
